  ...
  return (
    <Layout>
      ...
      <Wrapper>
        ...
        <SectionsList>
          <Item>
            <a href="#type1">Types of Data collected </a>
          </Item>
          <Item>
            <a href="#information">Information Collection and Use</a>
          </Item>
          <Item>
            <a href="#type2">Types of Data Collected</a>
          </Item>
          <Item>
          ...
          <Item>
            <a href="#disclosure">Disclosure Of Data</a>
          </Item>
          <Item>
            <a href="#security">Security Of Data</a>
          </Item>
          <Item>
          ...
          <Item>
            <a href="#link-other-site">Links To Other Sites</a>
          </Item>
          <Item>
            <a href="#children-privacy">Children's Privacy</a>
          </Item>
          <Item>
            <a href="#change-privacy">Changes To This Privacy Policy</a>
          </Item>
          <Item>
        ...
        <Priv>
          <div class="lower-content">
            ...
            <div class="text">
              <p>
                The Bailee App LLC ("us", "we", or "our") operates the website
                and the The Bailee App mobile application (the "Service"). This
                page informs you of our policies regarding the collection, use,
                and disclosure of personal data when you use our Service and the
                choices you have associated with that data. This Privacy Policy
                for The Bailee App LLC is powered by FreePrivacyPolicy.com.
              </p>
              <p>
                {" "}
            ...
            <div class="text">
              ...
              <p>
                ...
                or through a mobile device ("Usage Data"). This Usage Data may
                ...
                unique device identifiers and other diagnostic data. Tracking
                &amp; Cookies Data We use cookies and similar tracking
                technologies to track the activity on our Service and hold
                certain information. Cookies are files with small amount of data
                which may include an anonymous unique identifier. Cookies are
            ...
            <div class="text">
              <p>
                The Bailee App LLC uses the collected data for various purposes:
              </p>
              <ul>
                <li>
            ...
            <div class="text">
              <p>
                ...
                to that transfer. The Bailee App LLC will take all steps
            ...
            <div class="text">
              <p>
                ...
                <br />
                The Bailee App LLC may disclose your Personal Data in the good
              ...
              <ul>
                ...
                <li>
                  <p>
                    To protect and defend the rights or property of The Bailee
                    App LLC
                  </p>
                </li>
                <li>
            ...
            <div class="text">
              ...
              <p>
                ...
                practices of Google, please visit the Google Privacy &amp; Terms
                web page:{" "}
            ...
            <div class="text">
              ...
              <ul>
                <li>
                  <p>By email: support@thebaileeapp.com</p>
                </li>
                <li>
                  <p>
                    By visiting this page on our website: www.thebaileeapp.com
                  </p>
                </li>
                <li>
                  <p>By mail: thebaileeapp@gmail.com</p>
                </li>
              </ul>
            </div>
          </div>
