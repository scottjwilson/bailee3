  ...
  return (
    <Layout>
      ...
      <Wrapper>
        ...
        Terms and Conditions of The Bailee App, inc. Last updated June 23, 2018.
        <SectionsList>
     
              <Item><a href="#agreement">agreement to terms</a></Item>
              <Item><a href="#intellectual">intellectual property rights</a></Item>
              <Item><a href="#user">user representations</a></Item>
              <Item><a href="#prohibited">prohibited activities</a></Item>
              <Item><a href="#mobile">mobile application license</a></Item>
              <Item><a href="#submissions">submissions</a></Item>
              <Item><a href="#site-management">site managements</a></Item>
              <Item><a href="#privacy-policy">privacy policy</a></Item>
              <Item><a href="#terms-termination">terms and termination</a></Item>
              <Item><a href="#modification-interruption">modifications and interruptions</a></Item>
              <Item><a href="#governing-law">governing law</a></Item>
              <Item><a href="#dispute-resolution">dispute resolution</a></Item>
              <Item><a href="#corrections">corrections</a></Item>
              <Item><a href="#disclamer">disclamer</a></Item>
              <Item><a href="#limitations">limitations of liability</a></Item>
              <Item><a href="#indemnification">indemnification</a></Item>
              <Item><a href="#user-data">user data</a></Item>
              <Item><a href="#electronic-communication">electronic communication, transacations, and signatures</a></Item>
              <Item><a href="#california-users">california users and residents</a></Item>
              <Item><a href="#miscellaneous">miscellaneous</a></Item>
              <Item><a href="#contact-us">contact us</a></Item>
        ...
        <div class="lower-content">
          ...
          <div class="text">
              <p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and The Bailee App LLC (“we,” “us” or “our”), concerning your access to and use of the www.thebaileeapp.com website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
          ...
          <h2 id="intellectual">INTELLECTUAL PROPERTY RIGHTS</h2>
          <div class="text">
          ...
          <h2 id="user">USER REPRESENTATIONS</h2>
          <div class="text">
          ...
          <h2 id="mobile">MOBILE APPLICATION LICENSE</h2>
          <div class="text">
              <p><b>Use License</b></p>
              <p>
                  ...
                  <li><p>Remove, alter, or obscure any proprietary notice (including any notice of copyright or trademark) posted by us or the licensors of the application</p></li>
                  ...
                  <li><p>Use any proprietary information or any of our interfaces or our other intellectual property in the design, development, manufacture, licensing, or distribution of any applications, accessories, or devices for use with the application.</p></li>
              </ul>
              <br />
              ...
              <ul>
                  <li><p>The license granted to you for our mobile application is limited to a non-transferable license to use the application on a device that utilizes the Apple iOS or Android operating systems, as applicable, and in accordance with the usage rules set forth in the applicable App Distributor’s terms of service</p></li>
                  <li><p>We are responsible for providing any maintenance and support services with respect to the mobile application as specified in the terms and conditions of this mobile application license contained in these Terms of Use or as otherwise required under applicable law, and you acknowledge that each App Distributor has no obligation whatsoever to furnish any maintenance and support services with respect to the mobile application.</p></li>
                  <li><p>In the event of any failure of the mobile application to conform to any applicable warranty, you may notify the applicable App Distributor, and the App Distributor, in accordance with its terms and policies, may refund the purchase price, if any, paid for the mobile application, and to the maximum extent permitted by applicable law, the App Distributor will have no other warranty obligation whatsoever with respect to the mobile application.</p></li>
                  ...
                  <li><p>You must comply with applicable third-party terms of agreement when using the mobile application, e.g., if you have a VoIP application, then you must not be in violation of their wireless data service agreement when using the mobile application</p></li>
                  <li><p>You acknowledge and agree that the App Distributors are third-party beneficiaries of the terms and conditions in this mobile application license contained in these Terms of Use, and that each App Distributor will have the right (and will be deemed to have accepted the right) to enforce the terms and conditions in this mobile application license contained in these Terms of Use against you as a third-party beneficiary thereof.</p></li>
              </ul>
          </div>
          ...
          <div class="text">
              ...
              <ul>
                  <li><p>Monitor the Site for violations of these Terms of Use</p></li>
                  <li><p>Take appropriate legal action against anyone who, in our sole discretion, violates the law or these Terms of Use, including without limitation, reporting such user to law enforcement authorities.</p></li>
                  <li><p>In our sole discretion and without limitation, refuse, restrict access to, limit the availability of, or disable (to the extent technologically feasible) any of your Contributions or any portion thereof.</p></li>
                  <li><p>In our sole discretion and without limitation, notice, or liability, to remove from the Site or otherwise disable all files and content that are excessive in size or are in any way burdensome to our systems.</p></li>
                  <li><p>Otherwise manage the Site in a manner designed to protect our rights and property and to facilitate the proper functioning of the Site.</p></li>
              </ul>
          </div>
          ...
          <h2 id="modification-interruption">MODIFICATIONS AND INTERRUPTIONS</h2>
          <div class="text">
          ...
          <div class="text">
              <p>Any legal action of whatever nature brought by either you or us (collectively, the “Parties” and individually, a “Party”) shall be commenced or prosecuted in the state and federal courts located in united states County, Georgia, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Terms of Use. In no event shall any claim, action, or proceeding brought by either Party related in any way to the Site be commenced more than one (1) years after the cause of action arose.</p>
          </div>
          ...
          <div class="text">
              ...
              <ol>
                  <li><p>ERRORS, MISTAKES, OR INACCURACIES OF CONTENT AND MATERIALS</p></li>
                  <li><p>PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF THE SITE</p></li>
                  <li><p>ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION STORED THEREIN</p></li>
                  <li><p>ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM THE SITE</p></li>
                  <li><p>ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE SITE BY ANY THIRD PARTY, AND/OR</p></li>
                  <li><p>ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF ANY CONTENT POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE SITE. WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE SITE, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE APPLICATION FEATURED IN ANY BANNER OR OTHER ADVERTISING, AND WE WILL NOT BE A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND ANY THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES. AS WITH THE PURCHASE OF A PRODUCT OR SERVICE THROUGH ANY MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD USE YOUR BEST JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE.</p></li>
              </ol>
          </div>
          ...
          <div class="text">
              ...
              <ol>
                  <li><p>Use of the Site</p></li>
                  <li><p>Breach of these Terms of Use</p></li>
                  <li><p>Any breach of your representations and warranties set forth in these Terms of Use</p></li>
                  <li><p>Your violation of the rights of a third party, including but not limited to intellectual property rights</p></li>
                  <li><p>Any overt harmful act toward any other user of the Site with whom you connected via the Site. Notwithstanding the foregoing, we reserve the right, at your expense, to assume the exclusive defense and control of any matter for which you are required to indemnify us, and you agree to cooperate, at your expense, with our defense of such claims. We will usereasonable efforts to notify you of any such claim, action, or proceeding which is subject to this indemnification upon becoming aware of it.</p></li>
              </ol>
          </div>
          ...
          <h2 id="electronic-communication">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
          <div class="text">
          ...
          <h2 id="california-users">CALIFORNIA USERS AND RESIDENTS</h2>
          <div class="text">
          ...
          <div class="text">
              ...
              <p><b>The Bailee App LLC beaver falls dr norcross, GA 30071 United States<br />
                      Phone: __________<br />
                      support@thebaileeapp.com</b>
              </p>
          </div>
